...
const [selectedCandidate, setSelectedCandidate] = useState({});
  ...
  // You can add API POST or PUT call here
  console.log("Submitted form:", formData.get("candidateName"));
  setShowModal(false);
};
 ...
 try {
    ...
    // Optional: Get filename from response headers
    ...
    <>
      ...
      <div className="h-100 mt-5">
                ...
                {candidateDetails.length > 0 ? (
                  candidateDetails.map((data, idx) => (
                    ...
                    >
                      ...
                      <td>
                        {data?.JD_From_applied_Position && (<><a href="#" onClick={(e)=>handleShow(e,data?.Candidate_Id,"jd")}>view JD,</a> <br /></>)}
                        {data?.CV_Resume && <><a href="#!" onClick={(e)=>handleShow(e,data?.Candidate_Id,"cv")}>View CV,</a><br /></>}
                        {data?.Cover_Letter&& <> <a href="#!" onClick={(e)=>handleShow(e,data?.Candidate_Id,"cl")}>View CL</a></>}
                      </td>
        ...
        <div className="d-flex gap-2">
          <Button size="sm" variant="success" onClick={() => handleEdit(data)}>
            <FaEdit />
          </Button>
    ...
    <form id="candidateForm">
      <div className="row mb-2">
        <div className="col">
          ...
          >
            ...
            {[...new Set(candidateDetails.map(item => item.Req_ID))].map((id, i) => (
        ...
        <div className="col">
          ...
          >
            ...
            {[...new Set(candidateDetails.map(item => item.Candidate_Id))].map((id, i) => (
              <option key={i} value={id}>{id}</option>
            ))}
          </select>
        </div>
      ...
      <div className="row mb-2">
        <div className="col">
          ...
          <input
            className="form-control"
            name="currentStage"
            defaultValue={selectedCandidate?.Candidate_current_stage || ""}
          />
        </div>
        <div className="col">
      ...
      <div className="row">
        ...
        <div className="col">
          ...
          <input type="file" name="jd" className="form-control" />
        </div>
        <div className="col">
