...
const InterviewForm = () => {
  ...
  const validateForm = () => {
    if (!reqId || !role || !techStacks || !screeningType || !noOfRounds || !feedbackText || rating === 0) {
        ...
        <Row className="mb-4">
          <Col md={6} className="mb-3 px-2">
            <Form.Group>
              ...
              <Form.Control type="text" placeholder="Enter tech stacks" onChange={(e) => setTechStacks(e.target.value)}/>
            </Form.Group>
          </Col>
          <Col md={6} className="mb-3 px-2">
            <Form.Group>
        ...
        <Row className="mb-4">
          <Col md={6} className="mb-3 px-2">
            <Form.Group>
              ...
              <Form.Control type="number" placeholder="Enter number of rounds"   onChange={(e) => setNoOfRounds(e.target.value)} />
            </Form.Group>
          </Col>
        </Row>
          ...
          <div className="parameter-scroll-wrapper">
            ...
            {parameters.map((param, index) => (
              <div className="parameter-body" key={index}>
                <Form.Select value={param.score_card || ''} onChange={(e) => handleChange(index, 'score_card', e.target.value)}>
                  <option value="">Select</option>
                  <option value="Coding written">Coding written</option>
                  <option value="Technical round">Technical round</option>
                </Form.Select>
                <Form.Control type="text" value={param.options || ''} onChange={(e) => handleChange(index, 'options', e.target.value)} placeholder="Option" />
                ...
                <Form.Control type="number" value={param.min_questions || ''} onChange={(e) => handleChange(index, 'min_questions', e.target.value)} placeholder="Min Qs" />
                <Form.Control type="text" value={param.screen_type || ''} onChange={(e) => handleChange(index, 'screen_type', e.target.value)} placeholder="Screening Type" />
        ...
        <div className="feedback-section">
          <Row className="mt-5">
            ...
            <Col md={4} className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter feedback"  onChange={(e) => setFeedbackText(e.target.value)} />
            </Col>
          </Row>
        </div>
