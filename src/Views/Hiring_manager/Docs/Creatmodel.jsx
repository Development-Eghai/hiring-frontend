                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group className="mb-3">
                            <Form.Label>Date of new job Requisition<span className="text-danger">*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3">
                            <Form.Label>Job Requisition Template<span className="text-danger">*</span></Form.Label>
                            <Form.Select
                                name="jobTemplate"
